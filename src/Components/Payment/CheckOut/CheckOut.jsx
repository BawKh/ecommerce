...
export default function CheckOut() {
    ...
    function handleOnlinePayment(data) {
        axios.post(`https://ecommerce.routemisr.com/api/v1/orders/checkout-session/${cartID}`, {
            ...
            toast.success("Redirecting to payment page..." , {position: 'top-left' , duration: 1000});
            window.open(res.data.session.url, '_self'); // Open the payment URL in a new tab
